    ...
    <section ref={containerRef} className="py-20 bg-white font-sans w-full flex justify-center">
      ...
      <div className="container px-4 max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div
            ref={leftCardRef}
            className="group relative bg-[#FFD6E8] rounded-[40px] p-8 md:p-14 overflow-hidden min-h-[500px] md:min-h-[550px] flex flex-col justify-start transition-transform duration-500 hover:scale-[1.01]"
          >
            <div className="relative z-10 max-w-lg">
              ...
              {/* Heading */}
              <h2 className="text-4xl md:text-6xl font-urbanist font-bold leading-[1.1] mb-8 text-[#1A1A1A] tracking-tight">
          ...
          <div
            ref={rightCardRef}
            className="group relative bg-[#C9E2FF] rounded-[40px] p-8 md:p-14 overflow-hidden min-h-[500px] md:min-h-[550px] flex flex-col justify-start transition-transform duration-500 hover:scale-[1.01]"
          >
            <div className="relative z-10 max-w-lg">
              {/* Tagline */}
