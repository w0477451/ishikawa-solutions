    ...
    <div className="w-full min-h-screen bg-white font-urbanist overflow-x-hidden">
      ...
      <div className="px-4 pt-20 pb-0 relative z-30">
        <div 
          ...
          className="max-w-[95%] mx-auto bg-[#CFE5FF] rounded-[50px] min-h-[600px] lg:min-h-[650px] relative flex items-center overflow-visible"
        >
          ...
          <div className="container mx-auto px-8 lg:px-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center h-full relative z-10">
            ...
            <div className="flex flex-col items-start py-16">
              ...
              <h1 className="text-5xl lg:text-7xl font-extrabold text-[#3D3028] leading-[1.1] mb-8">
            ...
            */}
            <div className="absolute bottom-0 right-0 lg:right-10 w-full lg:w-1/2 h-full flex items-end justify-center lg:justify-end pointer-events-none z-20">
               <img 
                 ...
                 className="w-auto h-[100%] lg:h-[135%] max-w-none object-contain object-bottom animate-[float_6s_ease-in-out_infinite]" 
               />
            </div>
          </div>
        </div>
